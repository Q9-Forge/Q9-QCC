...
| `CALLIND <nargs>` / `CALLINDP <nargs>` | `f, a1..aN → r`/`p` | indirect call; the function pointer sits AT THE BOTTOM (below the arguments), above it the arguments left→right as with `CALL` |
