...
2. `const` fuer Skalare/Arrays und `static`: erledigt (2026-07-24, siehe Tabelle oben).
   Noch offen: Pointee-Constness (`const char*`), static-Initialisierer,
...
- Pointee-Constness (`const char*` schreibgeschuetzt, im Unterschied zu `char* const`)
- static-Lokale mit Initialisierer, static-`struct`-Lokale, static-Arrays, Funktions-Scoping fuer static-Lokale-Namen
- `void`/`void *`
