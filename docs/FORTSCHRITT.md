...
2,1-MB-OS-9-Modul. **Der komplette Tiny-C-Vollport von `Source/parsec.cpp` ist
...
| Tiny-C `switch`/`case`/`default` | teilweise | gestapelte Case-Label (case A: case B: body) unterstuetzt, KEIN Fallthrough mit Code zwischen verschiedenen Bodies (deckt das reale Nutzungsmuster in parsec.cpp/codegen.cpp ab); kein Backend-Change |
