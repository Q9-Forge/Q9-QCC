...
8. doppelte `#DEFMODUL`-Angabe — 🟢 `17k`/`17l`
...
- **8. doppelte `#DEFMODUL`-Angabe** — 🟢 erledigt 22.09.2026: NAME/EDITION/STACK/ATTR/TYPE melden bei zweiter Angabe SEMERR mit Klartext (17k/17l), dasselbe tcErrAt/actionErrors++-Muster wie bei den Auffangregeln. Erste Angabe bleibt gültig, wird nicht überschrieben.
